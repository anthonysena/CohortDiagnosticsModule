...
rCode <- ParallelLogger::createArgFunction(functionName = 'executeDiagnostics',
                                           excludeArgs = c("cohortDefinitionSet", 
                                                           ...
                                                           "minCellCount",
                                                           "incrementalFolder"),
                                           newName = "createCohortDiagnosticsModuleSpecifications",
                                           rCode = rCode)
...
OhdsiRTools::createRenvLockFile(rootPackage = "CohortDiagnostics",
                                ...
                                mode = "description",
                                additionalRequiredPackages = c("CohortDiagnostics",
                                                               "checkmate", 
                                                               "CirceR", 
                                                               "CohortGenerator",
                                                               "testthat",
